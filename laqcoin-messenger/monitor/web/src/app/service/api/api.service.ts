...
export class ApiService {
  ...
  addOrder(data: FormData) {
    return this.handleReq(this.bankUrl, 'laqbank/order/addOrder', data);
  }
  getConvertible(data: FormData) {
    return this.handleReq(this.bankUrl, 'laqbank/node/getConvertible', data);
  }
  getBalance(data: FormData) {
    return this.handleReq(this.bankUrl, 'laqbank/node/get', data);
  }
  getNodeOrders(data: FormData) {
    return this.handleReq(this.bankUrl, 'laqbank/order/getNodeOrder', data);
  }
  ...
  getWalletNewAddress(data: FormData) {
    return this.handleReq(this.bankUrl, 'laqpay/tools/newAddress', data);
  }
  getWalletInfo(data: FormData) {
    return this.handleReq(this.bankUrl, 'laqpay/node/get', data);
  }
  jsonp(url: string) {
    if (url === '') {
