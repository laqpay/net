...
import (
	...
	"github.com/laqpay/net/laqpay-messenger/websocket"
	"github.com/laqpay/net/laqpay-messenger/websocket/data"
	"github.com/laqpay/laqpay/src/util/browser"
...
func parseFlags() {
	...
	flag.StringVar(&seedPath, "seed-path", filepath.Join(file.UserHome(), ".laqim", "account"), "dir path to save seeds info")
	flag.Parse()
}
...
func main() {
	...
	if len(seedPath) < 1 {
		seedPath = filepath.Join(file.UserHome(), ".laqim", "account")
	}
